            ...
            <div className="padding-footer row  ">
              <div className='col'  >
                ...
                <div className='d-flex flex-row' >
                  {/* <img src="\src\assets\Layout\social\social.png" alt="" /> */}
                  <a href="https://www.facebook.com/nttdataespana/">
  <img src="\src\assets\Layout\social\facebook3.svg" alt="Facebook" />
</a>

<a href="https://twitter.com/NTTDataSpain?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor">
  <img src="\src\assets\Layout\social\twitter3.svg" alt="Twitter" />
</a>

<a href="https://es.linkedin.com/company/ntt-data-europe-latam">
  <img src="\src\assets\Layout\social\linkedin3.svg" alt="LinkedIn" />
</a>

<a href="https://www.instagram.com/nttdata.espana/?hl=es">
  <img src="\src\assets\Layout\social\instagram3.svg" alt="Instagram" />
</a>

<a href="https://www.youtube.com/c/nttdataeuropelatam">
  <img src="\src\assets\Layout\social\youtube3.svg" alt="YouTube" />
</a>
...
<div className="col-1 users">
  ...
  <img className="pb-2" src="\src\assets\GetApp\AppStore.svg" alt="YouTube" />
</a>
<a  href="https://play.google.com/store/apps/dev?id=6117871081971211022">
  <img className="pb-2" src="\src\assets\GetApp\Android.svg" alt="YouTube" />
</a>
              </div>
            </div>
          </div>
